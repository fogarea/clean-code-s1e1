...
var createNewTaskElement=function(taskString){
    ...
    listItem.className='incomplete-tasks__item task';
    ...
    editButton.className="task__button button button--edit";

    deleteButton.className="task__button button button--delete";
